[![Unit tests (python versions)](https://github.com/FarmHJ/numerical-solver/actions/workflows/unit-tests.yml/badge.svg)](https://github.com/FarmHJ/numerical-solver/actions/workflows/unit-tests.yml)
