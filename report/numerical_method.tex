...
\includegraphics[width=0.5\columnwidth]{predictor_corrector_error_behaviour}
...
\includegraphics[width=0.5\columnwidth]{ode45_absolute_sum_error_behaviour.JPG}

\includegraphics[width=0.5\columnwidth]{ode45_relative_sum_error_behaviour.JPG}